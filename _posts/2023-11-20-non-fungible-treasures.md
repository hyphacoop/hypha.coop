...
<figure class="pb4">
    <div class='flex-l items-center justify-center' style="width: 100%;">
        <img style='width:80%;' src="{{ '/assets/images/posts/2023-11-20-hr-final.gif' | relative_url }}" alt="Hawking Radiation's smart contract ASCII art animated"/>
    </div>
...
<figcaption>Infinite Canvas on Ethereum's mainnet</figcaption>
</figure>
